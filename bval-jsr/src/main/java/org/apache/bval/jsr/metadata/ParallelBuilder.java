...
public class ParallelBuilder {
    ...
    private static class Delegator<DELEGATE extends MetadataBuilder.Level> implements MetadataBuilder.Level {
    ...
    private static class ForBean extends ParallelBuilder.Delegator<MetadataBuilder.ForBean>
        ...
        public MetadataBuilder.ForClass getClass(Metas<Class<?>> meta) {
            return new ParallelBuilder.ForClass(this, primaryDelegate.getClass(meta), customDelegate.getClass(meta));
        }

        @Override
        public Map<String, MetadataBuilder.ForContainer<Field>> getFields(Metas<Class<?>> meta) {
            return merge(b -> b.getFields(meta), (t, u) -> new ParallelBuilder.ForContainer<>(this, t, u),
                EmptyBuilder.instance()::forContainer);
        }

        @Override
        public Map<String, MetadataBuilder.ForContainer<Method>> getGetters(Metas<Class<?>> meta) {
            return merge(b -> b.getGetters(meta), (t, u) -> new ParallelBuilder.ForContainer<>(this, t, u),
                EmptyBuilder.instance()::forContainer);
        }

        @Override
        public Map<Signature, MetadataBuilder.ForExecutable<Constructor<?>>> getConstructors(Metas<Class<?>> meta) {
            return merge(b -> b.getConstructors(meta), (t, u) -> new ParallelBuilder.ForExecutable<>(this, t, u),
                EmptyBuilder.instance()::forExecutable);
        }

        @Override
        public Map<Signature, MetadataBuilder.ForExecutable<Method>> getMethods(Metas<Class<?>> meta) {
            return merge(b -> b.getMethods(meta), (t, u) -> new ParallelBuilder.ForExecutable<>(this, t, u),
                EmptyBuilder.instance()::forExecutable);
        }
    }
    ...
    private static class ForContainer<DELEGATE extends MetadataBuilder.ForContainer<E>, E extends AnnotatedElement>
        extends ParallelBuilder.ForElement<DELEGATE, E> implements MetadataBuilder.ForContainer<E> {
        ...
        public final Map<ContainerElementKey, MetadataBuilder.ForContainer<AnnotatedType>> getContainerElementTypes(
            ...
            return merge(b -> b.getContainerElementTypes(meta),
                (t, u) -> new ParallelBuilder.ForContainer<>(this, t, u), EmptyBuilder.instance()::forContainer);
        }
    }
    ...
    private static class ForExecutable<DELEGATE extends MetadataBuilder.ForExecutable<E>, E extends Executable>
        ...
        public MetadataBuilder.ForContainer<E> getReturnValue(Metas<E> meta) {
            return new ParallelBuilder.ForContainer<>(this, primaryDelegate.getReturnValue(meta),
        ...
        public List<MetadataBuilder.ForContainer<Parameter>> getParameters(Metas<E> meta) {
            ...
            return IntStream.range(0, primaries.size())
                .mapToObj(n -> new ParallelBuilder.ForContainer<>(this, primaries.get(n), customs.get(n)))
                .collect(ToUnmodifiable.list());
        }

        @Override
        public MetadataBuilder.ForElement<E> getCrossParameter(Metas<E> meta) {
            return new ParallelBuilder.ForElement<MetadataBuilder.ForElement<E>, E>(this,
    ...
    public static MetadataBuilder.ForBean forBean(MetadataBuilder.ForBean primaryDelegate,
        ...
        return new ParallelBuilder.ForBean(primaryDelegate, customDelegate);
    }
}
